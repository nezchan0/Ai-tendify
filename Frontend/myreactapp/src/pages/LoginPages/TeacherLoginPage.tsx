    ...
    <div className="min-h-screen bg-[#121212] flex flex-col">
      ...
      <nav className="bg-[#1A1A1A] border-b border-white/10 py-4">
        <div className="container mx-auto px-4 flex justify-center space-x-6">
          ...
          <Link to="/login/teacher" className="text-indigo-500 font-medium">Teacher Login</Link>
          <Link to="/login/hod" className="text-gray-400 hover:text-white transition-colors">HOD Login</Link>
        </div>
      </nav>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="max-w-md w-full space-y-8 bg-[#1A1A1A] p-8 rounded-2xl border border-white/10">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-3xl font-bold text-white">Teacher Login</h2>
